...
class HeaderSettingsPage extends Page
{
    ...
    protected static string $view = 'filament.tenant.pages.header-settings';
    ...
    public function mount(): void
    {
        ...
        $header   = $tenantId ? Header::forTenant($tenantId) : new Header();
    ...
    public function save(): void
    {
        ...
        if ($tenantId) {
            $header = Header::forTenant($tenantId);
            $header->update($data);
        }
